...
\subsubsection[{connected}]{\setlength{\rightskip}{0pt plus 5cm}void BConnection::connected (quint32 {\em sessid})\hspace{0.3cm}{\ttfamily  \mbox{[}signal\mbox{]}}}}
...
\subsubsection[{sendObjects}]{\setlength{\rightskip}{0pt plus 5cm}void BConnection::sendObjects ({\bf BObList} $\ast$ {\em list})\hspace{0.3cm}{\ttfamily  \mbox{[}slot\mbox{]}}}}
