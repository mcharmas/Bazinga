...
if __name__ == "__main__":
    ...
    checkPacket = Packet.packetFromContent(1, Packet.Sources.APPLICATION, 0, Packet.Communicates.CHECK, "")
    normalContent = Packet.packetFromContent(1, Packet.Sources.DRIVER, 0, Packet.Communicates.OBJECT, "to sa jakies pierdoly.... i jeszcze wieksze peirdoly")
